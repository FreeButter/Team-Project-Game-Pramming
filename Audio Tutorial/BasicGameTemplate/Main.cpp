...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	HDEVNOTIFY hNewAudio = nullptr;
    {
        ...
        wcex.lpszClassName = L"BasicGameTemplateWindowClass";
        ...
        HWND hwnd = CreateWindowEx(0, L"BasicGameTemplateWindowClass", L"BasicGameTemplate", WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // TODO: Change to CreateWindowEx(WS_EX_TOPMOST, L"BasicGameTemplateWindowClass", L"BasicGameTemplate", WS_POPUP,
